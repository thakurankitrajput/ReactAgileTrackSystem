* You can follow series of command to setup Angular environment once you are in your project-name folder:
	...
	npm run start -> To compile and deploy the project in browser. You can press <Ctrl> key while clicking on localhost:8081 (or you can confirm in terminal) to open project in browser -> takes 2 to 3 min
...
* You may also run “npm run jest” to see the summary of test cases while developing the solution to re-factor the code to pass the test-cases.
